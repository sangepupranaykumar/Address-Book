...
public class DeleteContact {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Press 1 to Add Person/n Press 2 To Edit Contact/n press 3 to Delete Contact"+choice);
        switch (choice) {
            case 1:
            ...
            case 3:
                System.out.println("***To Delete the Contact***");
                System.out.println(" Enter the Number of Contacts ");
                ...
                for (int i = 1; i <= input1; i++) {
                    ...
                    for (AddressBookMain contacts : obj.listOfContacts) {
                        if (contacts.getFirstName().equals(firstName)) {
                            obj.listOfContacts.remove(contacts);
                            System.out.println("Delete the contact" + firstName);
                            obj.printContactDetails();
                            break;
                        } else {
